    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-md w-full mx-auto pb-8">
        ...
        <div className="bg-white mt-2 p-5 border-y border-gray-100">
          <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4">Status Pesanan</h3>
          <div className="relative border-l-2 border-gray-100 ml-3 space-y-6">
            <div className="relative">
              ...
              <div className="pl-6 pt-0.5">
                <p className="font-bold text-gray-900 text-sm">Dibayar</p>
                <p className="text-xs text-gray-400 mt-0.5">21 Jun 2026, 09:45</p>
              </div>
            </div>
            <div className="relative">
              <div className="absolute -left-[21px] top-0 w-10 h-10 bg-white flex items-center justify-center">
                <div className="w-6 h-6 bg-rose-100 rounded-full border-2 border-rose-500 flex items-center justify-center">
                  <div className="w-2.5 h-2.5 bg-rose-500 rounded-full animate-pulse" />
                </div>
              </div>
              <div className="pl-6 pt-0.5">
                <p className="font-bold text-gray-900 text-sm">Diproses Outlet</p>
                <p className="text-xs text-gray-400 mt-0.5">Menunggu outlet menerima pesanan</p>
              </div>
            </div>
            <div className="relative opacity-40">
              ...
              <div className="pl-6 pt-0.5">
                <p className="font-bold text-gray-900 text-sm">Siap Diambil</p>
              </div>
            </div>
          </div>
        </div>
