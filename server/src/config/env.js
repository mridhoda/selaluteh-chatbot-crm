...
const raw = {
  ...
  channelCredentialEncryptionKey: process.env.CHANNEL_CREDENTIAL_ENCRYPTION_KEY || '',
  channelCredentialKeyVersion: process.env.CHANNEL_CREDENTIAL_KEY_VERSION || 'v1',
  channelCredentialFingerprintPepper: process.env.CHANNEL_CREDENTIAL_FINGERPRINT_PEPPER || '',
  telegramWebhookBodyLimit: process.env.TELEGRAM_WEBHOOK_BODY_LIMIT || '2mb',
  telegramWebhookMaxAttempts: parseInt(process.env.TELEGRAM_WEBHOOK_MAX_ATTEMPTS, 10) || 8,
  telegramWebhookRetryBaseMs: parseInt(process.env.TELEGRAM_WEBHOOK_RETRY_BASE_MS, 10) || 1000,
  telegramAllowedUpdates: process.env.TELEGRAM_ALLOWED_UPDATES || 'message,callback_query',
  telegramConnectionReconciliationEnabled: process.env.TELEGRAM_CONNECTION_RECONCILIATION_ENABLED || '',
  telegramLegacyTokenWebhookEnabled: process.env.TELEGRAM_LEGACY_TOKEN_WEBHOOK_ENABLED || '',
...
export const env = {
  ...
  channelCredentialEncryptionKey: raw.channelCredentialEncryptionKey,
  channelCredentialKeyVersion: raw.channelCredentialKeyVersion,
  channelCredentialFingerprintPepper: raw.channelCredentialFingerprintPepper,
  telegramWebhookBodyLimit: raw.telegramWebhookBodyLimit,
  telegramWebhookMaxAttempts: raw.telegramWebhookMaxAttempts,
  telegramWebhookRetryBaseMs: raw.telegramWebhookRetryBaseMs,
  telegramAllowedUpdates: raw.telegramAllowedUpdates,
  telegramConnectionReconciliationEnabled: raw.telegramConnectionReconciliationEnabled === 'true',
  telegramLegacyTokenWebhookEnabled: raw.telegramLegacyTokenWebhookEnabled === 'true',
...
export function redactedConfig() {
  return {
    ...
    channelCredentialEncryptionKey: env.channelCredentialEncryptionKey ? 'configured' : '',
    channelCredentialKeyVersion: env.channelCredentialKeyVersion,
    channelCredentialFingerprintPepper: env.channelCredentialFingerprintPepper ? 'configured' : '',
    telegramWebhookBodyLimit: env.telegramWebhookBodyLimit,
    telegramWebhookMaxAttempts: env.telegramWebhookMaxAttempts,
    telegramWebhookRetryBaseMs: env.telegramWebhookRetryBaseMs,
    telegramAllowedUpdates: env.telegramAllowedUpdates,
    telegramConnectionReconciliationEnabled: env.telegramConnectionReconciliationEnabled,
    telegramLegacyTokenWebhookEnabled: env.telegramLegacyTokenWebhookEnabled,
