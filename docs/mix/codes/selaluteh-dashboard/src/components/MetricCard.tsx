...
interface MetricCardProps {
  ...
  themeColor: 'purple' | 'blue' | 'emerald' | 'orange' | 'fuchsia' | 'pink';
  onClick?: () => void;
}
...
export default function MetricCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`card p-5 cursor-pointer relative overflow-hidden group select-none flex flex-col justify-between h-[180px] bg-white border border-slate-100 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.02)] ${selectedTheme.hoverBg} transition-colors`}
    >
      <div>
