import { Order, OutletStats, ChannelStats, Activity, ChannelType } from './types';
...
export const INITIAL_OUTLET_STATS: OutletStats[] = [
...
// Main 7-day historical sales data (from May 15 to May 21)
...
// Product categories & popular items for Outlet details view
export const OUTLET_POPULAR_PRODUCTS: Record<string, Array<{ name: string; sales: number; qty: number }>> = {
  'Danau Murung': [
...
// Customer simulated messages list for the interactive Chat simulator
