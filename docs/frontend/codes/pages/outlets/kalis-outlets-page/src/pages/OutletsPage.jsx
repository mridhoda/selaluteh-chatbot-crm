...
const outlets = [
  {
    ...
    activity: [
      ...
      ["warning", "Promotions published", "5 hours ago"],
    ],
  },
  {
    id: 2,
...
function ActivityIcon({ type }) {
  const map = {
    warning: {
      icon: AlertTriangle,
      className: "bg-rose-50 text-[#E5484D]",
    },
    success: {
      icon: CheckCircle2,
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="grid h-9 w-9 shrink-0 place-items-center rounded-xl border border-[#E1E6EF] text-[#667085] transition hover:bg-[#F6F8FB] hover:text-[#11182E]"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <section className="mt-6">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              className="inline-flex h-9 items-center gap-2 rounded-xl border border-[#E1E6EF] px-3 text-xs font-semibold text-[#11182E]"
            >
        ...
        <div className="mt-6 grid grid-cols-3 gap-3 border-t border-[#E1E6EF] pt-5">
          ...
          <button
            type="button"
            className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-[#D6DCE8] bg-white px-3 text-sm font-bold text-[#11182E] transition hover:bg-[#F6F8FB]"
          >
