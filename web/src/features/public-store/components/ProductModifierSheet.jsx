  ...
  const toggleOption = (group, option) => {
    ...
    setSelectedOptionIds((current) => {
      ...
      const selectedInGroup = current.filter((id) =>
        group.options.some((item) => item.id === id)
      )
    ...
    <>
      ...
      <div className='fixed bottom-0 left-0 right-0 z-50 mx-auto flex max-h-[90vh] max-w-md flex-col rounded-t-3xl bg-white shadow-2xl'>
        ...
        >
          ...
          <span>
            <span className='block text-xs font-black text-[var(--brand-700)]'>
        ...
        <div className='flex-1 overflow-y-auto pb-24'>
          <div className='px-4 pb-4'>
            ...
            <div className='mt-4'>
              ...
              <p className='mt-1 text-lg font-black text-[var(--brand-600)]'>
                {formatCurrency(product.basePriceMinor)}
              </p>
          ...
          <div className='p-4'>
            <h3 className='mb-2 text-sm font-black uppercase tracking-wide text-gray-900'>
              Catatan Opsional
            </h3>
            <textarea
              value={note}
        ...
        <div className='absolute bottom-0 left-0 right-0 border-t border-gray-100 bg-white p-4 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]'>
          ...
          <p className='mt-2 text-center text-[10px] text-gray-400'>
            Harga akan dihitung otomatis saat checkout.
          </p>
        </div>
      </div>
    </>
