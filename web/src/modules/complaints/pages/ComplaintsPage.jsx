                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                        <tr>
                            ...
                            <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#64748b' }}>Contact</th>
                            <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#64748b' }}>Issue</th>
                            <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#64748b' }}>Platform</th>
