...
import { X, Check, MapPin, TrendingUp, Sparkles } from 'lucide-react';
import { OUTLET_POPULAR_PRODUCTS } from '../data/mockDashboardData';
...
export default function DetailModal({
  ...
  // 1. If OUTLET details
  const renderOutletDetails = (outletName) => {
  ...
  const renderOrderDetails = (orderNo) => {
  ...
  const renderActivityDetails = (actId) => {
    return (
      <div className="space-y-5">
