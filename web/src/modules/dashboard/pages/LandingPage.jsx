...
import { 
    faComment, faCheck, faStar, faArrowRight, faBars, faTimes, faRobot, 
    faBolt, faShieldAlt, faChevronRight, faChartLine, faUsers 
        ...
        <nav className={`lp-navbar ${isScrolled ? 'scrolled' : ''}`}>
            <div className="lp-container lp-navbar-content">
                ...
                <div className="lp-auth-buttons">
                    ...
                    <Link to="/register" className="lp-btn-register">Daftar Sekarang</Link>
                </div>

                <button className="lp-mobile-toggle" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            ...
            {mobileMenuOpen && (
                <div className="lp-mobile-menu">
                    <div className="lp-mobile-menu-content">
                        {['Fitur', 'Harga', 'Testimoni'].map((item) => (
                            <a key={item} href={`#${item.toLowerCase()}`} className="lp-mobile-link">{item}</a>
                        ))}
                        <hr />
                        <Link to="/login" className="lp-btn-login-mobile">Login</Link>
                        <Link to="/register" className="lp-btn-register-mobile">Daftar Sekarang</Link>
                    </div>
                </div>
            )}
        </nav>
                    ...
                    <Reveal>
                        <div className="lp-hero-social-proof">
                            <div className="lp-hero-avatars">
                                {[1, 2, 3, 4].map((i) => (
                                    <img key={i} src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="User" className="lp-hero-avatar-img" />
                                ))}
                            </div>
                ...
                <div className="lp-hero-image-section">
                    <Reveal className="lp-hero-image-wrapper">
                        ...
                        <div className="lp-hero-card response-time">
                            <div className="lp-hero-card-icon" style={{ backgroundColor: '#D1FAE5', color: '#065F46' }}><FontAwesomeIcon icon={faChartLine} /></div>
                            <div>
                        ...
                        <div className="lp-hero-card daily-chats">
                            <div className="lp-hero-card-icon" style={{ backgroundColor: '#FFEDD5', color: '#9A3412' }}><FontAwesomeIcon icon={faComment} /></div>
                            <div>
        ...
        <section className="lp-section lp-chat-demo">
            <div className="lp-container lp-chat-demo-grid">
                     ...
                     <div className="lp-phone-mockup">
                        <div className="lp-phone-screen">
                            ...
                            <div className="lp-phone-chat-area">
                                <div className="lp-chat-bubble lp-user">Halo, apakah produk ini ready?</div>
                                <div className="lp-chat-bubble lp-bot">Tentu! Stok kami selalu update. Silahkan diorder kak! 😊</div>
                            </div>
                            <div className="lp-phone-input-area">
                                <div className="lp-phone-input-text">Ketik pesan...</div>
                                <div className="lp-phone-input-send"><FontAwesomeIcon icon={faArrowRight} /></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="lp-chat-demo-text">
                    <Reveal>
                        <div className="lp-section-icon"><FontAwesomeIcon icon={faBolt} /></div>
                        <h2 className="lp-section-title">Tingkatkan Penjualan dan Efisiensi</h2>
                    </Reveal>
                    <Reveal>
                        ...
                        {[
                            ...
                            <Reveal key={idx}>
                                <li className="lp-feature-item">
                                    <div className="lp-feature-icon"><FontAwesomeIcon icon={faCheck} /></div>
                                    {item}
                                </li>
                            </Reveal>
                        ))}
    ...
    <div className={`lp-pricing-card ${isPro ? 'pro' : ''}`}>
        ...
        <div className="lp-pricing-header">
            ...
            <div className="lp-pricing-price-wrapper">
                ...
                {price !== "Hubungi Kami" && <span className="lp-pricing-period">/bulan</span>}
            </div>
        </div>
        <hr />
        <ul className="lp-pricing-features">
            {features.map((feature, idx) => (
                <li key={idx}><FontAwesomeIcon icon={faCheck} className="lp-pricing-check" /> {feature}</li>
            ))}
        </ul>
        <Link to={price === "Hubungi Kami" ? "/contact" : "/register"} className="lp-btn lp-pricing-btn">
            ...
            <div className="lp-container">
                <div className="lp-section-header">
                    <Reveal>
                        ...
                        <p className="lp-section-subtitle">Investasi terbaik untuk pertumbuhan bisnis Anda. Upgrade kapan saja.</p>
                    </Reveal>
                </div>
                <div className="lp-pricing-grid">
                    <Reveal><PricingCard title="Basic" price="Rp 150rb" features={["1 Agen AI", "1.000 Pesan/Bulan", "Integrasi WhatsApp", "Analitik Dasar"]} /></Reveal>
                    <Reveal><PricingCard title="Pro" price="Rp 450rb" isPro={true} features={["5 Agen AI", "5.000 Pesan/Bulan", "Integrasi Multi-platform", "Analitik Lanjutan", "Dukungan Prioritas"]} /></Reveal>
                    <Reveal><PricingCard title="Enterprise" price="Hubungi Kami" features={["Agen AI Tanpa Batas", "Volume Pesan Kustom", "Fitur Kustom", "Dukungan Khusus (Dedicated)"]} /></Reveal>
                </div>
            </div>
        </section>
    );
    ...
    <div className="lp-testimonial-card">
        ...
        <div className="lp-testimonial-author">
            ...
            <div>
                ...
                <p className="lp-testimonial-role">{role}, {company}</p>
            </div>
        </div>
    </div>
);
...
const Testimonials = () => {
    const testimonials = [
        { quote: "Sejak menggunakan platform ini, efisiensi layanan pelanggan kami meningkat 200%. Sangat direkomendasikan!", name: "John Doe", role: "CEO", company: "TechCorp" },
        { quote: "Analitiknya sangat membantu kami memahami pelanggan. Penjualan kami naik 30% dalam tiga bulan pertama.", name: "Jane Smith", role: "Marketing Head", company: "Marketify" },
        { quote: "Agen AI-nya luar biasa! Menghemat banyak waktu tim kami untuk menjawab pertanyaan berulang.", name: "Emily White", role: "Ops Manager", company: "Logistix" }
    ];

    return (
        <section className="lp-section lp-testimonials" id="testimoni">
            <div className="lp-container">
                <Reveal><h2 className="lp-section-title lp-text-center">Apa Kata Klien Kami</h2></Reveal>
                <div className="lp-testimonials-grid">
                    {testimonials.map((t, idx) => (
                        <Reveal key={idx}><TestimonialCard {...t} /></Reveal>
                    ))}
                </div>
            </div>
        </section>
        ...
        <div className="lp-container">
            <div className="lp-footer-grid">
                <div className="lp-footer-about">
                    <div className="lp-logo">
                        <div className="lp-logo-icon small"><FontAwesomeIcon icon={faRobot} /></div>
                        <span className="lp-logo-text">KALIS.AI</span>
                    </div>
                    <p>Platform AI Customer Service terdepan untuk membantu bisnis Anda berkembang lebih cepat dengan otomatisasi cerdas.</p>
                </div>
                <div>
