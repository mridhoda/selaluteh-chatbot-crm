...
export default function GeneralSettingsForm({ settings, onSave, isSaving }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ padding: 24 }}>
      <h3 style={{ margin: '0 0 4px', color: 'var(--text-primary)', fontSize: 16, fontWeight: 600 }}>General Settings</h3>
      <p style={{ margin: '0 0 20px', color: 'var(--text-muted)', fontSize: 13 }}>Workspace identity and regional configuration.</p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <div style={FIELD}>
          ...
          <select className="input" value={form.timezone} onChange={e => set('timezone', e.target.value)} style={{ width: '100%' }}>
      ...
      <div style={FIELD}>
        ...
        <select className="input" value={form.locale} onChange={e => set('locale', e.target.value)} style={{ width: '100%' }}>
      ...
      <div style={{ ...FIELD, display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        />
        <label htmlFor="allowAllOutletsView" style={{ ...LABEL, margin: 0, cursor: 'pointer' }}>
